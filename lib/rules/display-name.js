...
module.exports = {
  ...
  create: Components.detect(function(context, components, utils) {
    ...
    function isDisplayNameDeclaration(node) {
      switch (node.type) {
        ...
        case 'PropertyDefinition':
          ...
          return !!(tokens[0].value === 'displayName' || (tokens[1] && tokens[1].value === 'displayName'));
        case 'Identifier':
    ...
    function hasTranspilerName(node) {
      ...
      return !!(namedObjectAssignment || namedObjectDeclaration || namedClass || namedFunctionDeclaration || namedFunctionExpression);
    }
