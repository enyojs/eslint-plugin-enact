 ...
 */
Components.prototype.list = function(filter) {
  var list = {};
  var usedPropTypes = {};
...
function componentRule(rule, context) {
  ...
  var utils = {
     ...
     *
     * @param {Node} node node to use as a reference point to retrieve a scope object
     ...
     *
     * @param {Node} scopeNode node to use as a reference point to retrieve a scope object
     * @returns {ASTNode} component node, null if we are not in a component
     */
    getParentES5Component: function(scopeNode) {
      var scope = sourceCode.getScope(scopeNode);
      while (scope) {
     ...
     * @returns {ASTNode} component node, null if we are not in a component
     */
    getParentES6Component: function(scopeNode) {
      var scope = sourceCode.getScope(scopeNode);
     ...
     * @returns {ASTNode} component node, null if we are not in a component
     */
    getParentStatelessComponent: function(scopeNode) {
      var scope = sourceCode.getScope(scopeNode);
      while (scope) {
